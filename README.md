...
面向小学阶段儿童的本地优先 Web 英语打字游戏集合。通过键位热身、青蛙跳荷叶、词语花园连连看和城市追踪，将键位学习、单词抄写、词义回忆与后续听写复习连接成一条学习路径。
...
- 字母小火车：中文释义在上、乱序字母在下，每 4 词从 100% 提示逐站减少到 0%，错键保留正确前缀，连续两错只临时增加 1 个提示字母；
